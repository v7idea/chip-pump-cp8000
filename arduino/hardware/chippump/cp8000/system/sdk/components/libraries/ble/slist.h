...
#define SYS_SLIST_ITERATE_FROM_NODE(__sl, __sn)                                            \
    for (__sn = __sn ? sys_slist_peek_next_no_check(__sn) : sys_sys_slist_peek_head(__l);  \
         __sn != NULL; __sn = sys_sys_slist_peek_next(__sn))
...
#define SYS_SLIST_FOR_EACH_NODE_SAFE(__sl, __sn, __sns)                                  \
    for (__sn = (void *)sys_slist_peek_head(__sl),                            \
        __sns = sys_slist_peek_next(__sn);                                 \
         __sn != NULL; __sn = __sns, __sns = sys_slist_peek_next(__sn))
